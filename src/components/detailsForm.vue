<template>
	<v-form>
		<v-row>
			<v-col cols="12" sm="3">
				<span class="black--text dark-v">Provider Name</span>
				<v-text-field
					label="First Name"
					outlined
					clearable
		...
		<v-row class="mt-n5">
			<v-col cols="12" sm="6">
				<span class="black--text dark-v">Provider's Email</span>
				<v-text-field
					label="Email Address"
					outlined
					clearable
		...
		<v-row class="mt-n5">
			<v-col cols="12" sm="6">
				<span class="black--text dark-v">Provider's Mobile Number</span>
				<v-text-field
					label="Mobile Number"
					outlined
					clearable
		...
		<v-row class="mt-n5">
			<v-col cols="12" sm="6">
				<span class="black--text dark-v">Provider's Gender</span>
				<v-select
					class="mt-2"
					clearable
					color="purple darken-2"
